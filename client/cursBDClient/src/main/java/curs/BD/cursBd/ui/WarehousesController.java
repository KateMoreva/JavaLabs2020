...
public class WarehousesController extends WindowController {
    ...
    @FXML
    void initialize() {
        setInputNumericFieldStyle(amountInputAdd);
        setInputNumericFieldStyle(amountInputChangeAmount);
        setInputNumericFieldStyle(quantityInputAdd);
        setInputNumericFieldStyle(quantityInputChangeQuantity);
    ...
    private void initChangeAmountButton() {
        changeAmountButton.setOnAction(actionEvent -> {
            if (nameInputChangeAmount.getText().isEmpty()) {
                ...
                showProcessResultMessage(SUCCESSFULLY_CHANGED);
                cleanTextField(amountInputChangeAmount);
                cleanTextField(nameInputChangeAmount);
                showAllTableData();
            } else {
                showProcessResultMessage(ERROR_NO_DATA);
                showAllTableData();
